...
class ResultSetMapping
{
    ...
    public function hasColumnAliasByField(string $alias, string $fieldName, string|null $declaringClass = null): bool
    {
        if ($declaringClass === null && ! isset($this->aliasMap[$alias])) {
            return false;
        }
    ...
    /** @param class-string|null $declaringClass */
    public function getColumnAliasByField(string $alias, string $fieldName, string|null $declaringClass = null): string
    {
        $declaringClass ??= $this->aliasMap[$alias];
